...
ASGI_APPLICATION = 'Menu.asgi.application'  # Uncommented for WebSocket support
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Restaurant <noreply@restaurant.com>')
